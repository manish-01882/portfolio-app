  ...
  return (
    <nav className="sticky top-0 z-50 w-full border-b bg-background/80 backdrop-blur-md px-4 py-2.5 md:px-8">
      <div className="flex items-center justify-between gap-4">
        ...
        >
          <div className="absolute -top-2 -left-2 h-4 w-4 border-l-2 border-t-2 duration-200 group-hover:-top-1 group-hover:-left-1" />
          <AnimatedTextLogo text={profileConfig.firstName} className="text-2xl" hover />
          <div className="absolute -bottom-2 -right-2 h-4 w-4 border-b-2 border-r-2 duration-200 group-hover:-bottom-1 group-hover:-right-1" />
        </a>
